COMMANDS = {
    "go <direction>": "перейти в направлении (north/south/east/west/etc.)",
    "north": "перейти на север (аналог go north)",
    "south": "перейти на юг",
...
ROOMS = {
    ...
    'dungeon': {
          'description': (
              'Вы в сыром и холодном подземелье. В углу что-то большое '
              'и темное шевелится в темноте.'
          ),
          'exits': {'up': 'trap_room'},
          'items': [],
          'puzzle': None
